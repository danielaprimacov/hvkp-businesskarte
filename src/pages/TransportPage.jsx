        ...
        <section className="mt-40 pt-10 mb-20" id="transport-info">
          <div className="flex flex-col justify-center items-center">
            ...
            <button
              ...
              className="mt-5 px-6 py-2 flex gap-3 rounded-md text-white text-xl tracking-wider uppercase bg-blue-400 transition duration-300 hover:scale-110 ease-in cursor-pointer"
            >
              Angebot anfordern
              <img
                src={arrowsIcon}
