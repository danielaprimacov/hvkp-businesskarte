        ...
        <div className="relative z-10 mx-auto max-w-6xl px-4 h-full flex items-center">
          <motion.div style={{ opacity: textOpacity }} className="text-white">
            ...
            <p className="mt-4 text-lg text-blue-50 bg-black/60 px-10 py-3 rounded">
              Fehlersuche, Reparatur und Service sowie Ersatzteilbeschaffung und
              Funktionsprüfung.
            </p>
          </motion.div>
        </div>
      ...
      <section className="mt-40 pt-10 mb-20" id="transport-info">
        <div className="flex flex-col justify-center items-center">
          ...
          <p className="w-[70rem] mb-10 text-center text-xl">
            ...
            Seriennummer, Fehlerbild (kurze Beschreibung/Fotos), Standort sowie
            Ihr Zeitfenster – wir melden uns kurzfristig mit einem Festpreis.
          </p>

          <button className="mt-5 px-6 py-2 flex gap-3 rounded-md text-white text-xl tracking-wider uppercase bg-[#4d898a] transition duration-300 hover:scale-110 ease-in cursor-pointer">
            Angebot anfordern
            <img
              src={arrowsIcon}
              className="w-6 pt-1"
