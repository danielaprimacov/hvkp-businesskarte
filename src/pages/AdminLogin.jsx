  ...
  return (
    <div className="bg-blue-200 min-h-screen pt-30">
      <div className="flex flex-col">
        <div className="w-full max-w-sm mx-auto p-6 border rounded">
          <h1 className="text-xl text-center font-semibold mb-4">Admin</h1>
        ...
        <Link
          to="/"
          className="text-center mt-5 hover:text-blue-500 transition duration-300"
        >
          Zurück
        </Link>
      </div>
