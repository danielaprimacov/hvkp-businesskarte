    ...
    <div className="pt-5">
      <div className="px-10 pb-30 flex justify-evenly items-center gap-10">
        ...
        <section className="flex flex-col justify-center items-center gap-5">
          <p className="w-150 text-xl text-black/70 text-center">
          ...
          <button className="py-5 px-10 rounded-md bg-blue-700 text-white text-lg tracking-wider cursor-pointer transition-all duration-300 hover:bg-blue-600 hover:scale-105">
