...
function Footer() {
  ...
  const PHONE = "+49 1590 1212377";
  const PHONE_E164 = PHONE.replace(/[^\d]/g, ""); // "4915901212377"
  ...
  return (
    <div className={`bg-gradient-to-b from-white ${theme.to} w-full`}>
      <div className="pt-5 p-6 sm:p-8 lg:p-10">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-10">
          ...
          <div className="mt-1 sm:mt-3 flex flex-col mr-0 sm:mr-2">
            <h3 className={`${theme.h3} uppercase mb-5 sm:mb-7`}>
              Social Media
            </h3>
